...
const Categories = ({ categories = data }: { categories?: Category[] }) => {
  ...
  return (
    <section className="overflow-hidden pt-17.5">
      <div className="max-w-[1800px] w-full mx-auto px-2 sm:px-3 pb-15 border-b border-gray-3">
          ...
          <div className="relative mb-10 flex items-center justify-center text-center">
            <div>
              ...
              <h2 className="font-semibold text-xl xl:text-heading-5 text-black">
                Quais brindes sua empresa precisa hoje?
              </h2>
            </div>

            <div className="absolute right-0 top-1/2 hidden -translate-y-1/2 items-center gap-3 sm:flex">
