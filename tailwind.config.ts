...
const config: Config = {
  ...
  theme: {
    fontFamily: {
      "euclid-circular-a": ["Nunito Sans", "sans-serif"],
    ...
    extend: {
      ...
      boxShadow: {
        ...
        2: "0px 20px 50px 0px rgba(28, 25, 23, 0.08), 0px 2px 8px 0px rgba(28, 25, 23, 0.04)",
        3: "0px 18px 46px 0px rgba(28, 25, 23, 0.14)",
        testimonial:
          "0px 24px 60px 0px rgba(28, 25, 23, 0.08), 0px 1px 0px 0px rgba(255,255,255,0.75) inset",
