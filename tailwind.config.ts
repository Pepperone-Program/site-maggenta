  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        2: "0px 20px 50px 0px rgba(75, 37, 66, 0.10), 0px 2px 8px 0px rgba(75, 37, 66, 0.05)",
        3: "0px 18px 46px 0px rgba(36, 24, 39, 0.16)",
        testimonial:
          "0px 24px 60px 0px rgba(75, 37, 66, 0.10), 0px 1px 0px 0px rgba(255,255,255,0.75) inset",
